namespace Moviq.Domain.Products.Tests
{
    ...
    public class ProductNoSqlRepositoryTests
    {
        ...
        [TestMethod]
        [TestCategory("ProductNoSqlRepository, when Set is executed with valid data")]
        ...
        [TestMethod]
        [TestCategory("ProductNoSqlRepository, when Get is executed with a valid Id")]
        ...
        [TestMethod]
        [TestCategory("ProductNoSqlRepository, when Find is executed with valid search criteria")]
